...
class ERPNextPreImportTests(unittest.TestCase):
    def _valid_files(self):
        return {
            ...
            "contacts.csv": [{"ID": "", "First Name": "Ada", "Operion Source Key": "wwi:contact:1", "Email ID (Email IDs)": "ada@example.test", "Is Primary (Email IDs)": "1", "Number (Contact Numbers)": "123", "Is Primary Phone (Contact Numbers)": "1", "Link Document Type (Links)": "Customer", "Link Name (Links)": "Customer A"}],
            "sales_orders.csv": [{"ID": "", "Customer": "Customer A", "Date": "2016-05-30", "Delivery Date": "2016-06-01", "Company": "AI Demo GmbH", "Currency": "EUR", "Exchange Rate": "1", "Operion Source Key": "wwi:sales_order:1", "Item Code (Items)": "wwi:product:1", "Delivery Date (Items)": "2016-06-01", "Quantity (Items)": "2", "Stock UOM (Items)": "Unit", "UOM (Items)": "Unit", "UOM Conversion Factor (Items)": "1", "Rate (Items)": "3.00", "Amount (Items)": "6.00", "Operion Source Key (Items)": "wwi:sales_order_line:1"}],
            "purchase_orders.csv": [{"ID": "", "Supplier": "Supplier B", "Date": "2016-05-30", "Required By": "2016-05-30", "Company": "AI Demo GmbH", "Currency": "EUR", "Exchange Rate": "1", "Operion Source Key": "wwi:purchase_order:2", "Item Code (Items)": "wwi:product:1", "Required By (Items)": "2016-05-30", "Quantity (Items)": "5", "Stock UOM (Items)": "Unit", "UOM (Items)": "Unit", "UOM Conversion Factor (Items)": "1", "Rate (Items)": "2.00", "Amount (Items)": "10.00", "Operion Source Key (Items)": "wwi:purchase_order_line:1"}],
        }
