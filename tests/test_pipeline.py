...
class PipelineTests(unittest.TestCase):
    ...
    def test_scenarios_are_explicitly_simulated_and_complete(self):
        ...
        self.assertEqual(
            [row["case_id"] for row in rows], ["F01", "F02", "F03", "F04", "F05", "F06"]
        )
    ...
    def test_validation_reports_broken_sales_order_reference(self):
        canonical = {
            ...
            "sales_orders": [
                {
                    "canonical_id": "wwi:sales_order:1",
                    "source_id": "1",
                    "customer_canonical_id": "wwi:organization:customer:404",
    ...
    def test_twenty_company_export_matches_reference_template(self):
        ...
        self.assertEqual(
            TWENTY_COMPANY_HEADERS,
            expected_headers[:-1] + ["WWI External ID", expected_headers[-1]],
        )
        ...
        organizations = [
            {
                **base,
                ...
                "name": "A",
                "website": "http://www.example.com/a",
            },
            {
                **base,
                "canonical_id": "wwi:organization:customer:2",
                "name": "B",
    ...
    def test_twenty_people_use_company_external_id_relation(self):
        ...
        self.assertEqual(
            rows[0]["Company WWI External ID"], "wwi:organization:customer:1"
        )
    ...
    def test_erpnext_masters_map_uom_and_contact_relation(self):
        ...
        item = _erpnext_item_rows(
            [
                {
                    "canonical_id": "wwi:product:1",
                    "name": "Widget",
                    "uom": "Each",
                    "unit_price_ex_tax": "12.50",
                }
            ]
        )[0]
    ...
    def test_erpnext_orders_combine_children_and_filter_closed_commitments(self):
        ...
        sales = _erpnext_sales_order_rows(
            [
                {
                    "canonical_id": "wwi:sales_order:1",
                    "customer_canonical_id": "wwi:organization:customer:1",
                    "order_date": "2016-05-30",
                    "expected_delivery_date": "2016-06-01",
            ...
            [
                {
                    "canonical_id": "wwi:sales_order_line:1",
                    "sales_order_canonical_id": "wwi:sales_order:1",
                    "product_canonical_id": "wwi:product:1",
                    "open_quantity": "2",
                    "unit_price_ex_tax": "3",
                    "uom": "Each",
                ...
                {
                    "canonical_id": "wwi:sales_order_line:2",
                    "sales_order_canonical_id": "wwi:sales_order:1",
                    "product_canonical_id": "wwi:product:1",
                    "open_quantity": "1",
                    "unit_price_ex_tax": "4",
        ...
        purchases = _erpnext_purchase_order_rows(
            [
                {
                    "canonical_id": "wwi:purchase_order:2",
                    "supplier_canonical_id": "wwi:organization:supplier:2",
                    "order_date": "2016-05-29",
                    "expected_delivery_date": "2016-06-02",
